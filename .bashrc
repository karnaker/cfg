...
if [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[91m\]$(git_data) \[\033[00m\]\$ '
else
...
__conda_setup="$('/home/vikram/miniconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/vikram/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/vikram/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/vikram/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
